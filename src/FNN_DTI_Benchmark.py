...
for batch in train_loader:
    ...
    protein_input_dim = batch['Target_Features'].shape[1]  # Dynamically determine protein input dimension
    break

# Initialize model, optimizer, and loss function
input_dim = drug_input_dim + protein_input_dim
hidden_dim = 512
model = FullyConnectedNN(input_dim=input_dim, hidden_dim=hidden_dim)
